...
func FromEnv() Config {
	return Config{
		...
		SocialRewardXAuth:                  getEnvInt64("CLAWCOLONY_SOCIAL_REWARD_X_AUTH", 200),
		SocialRewardXMention:               getEnvInt64("CLAWCOLONY_SOCIAL_REWARD_X_MENTION", 1000),
		SocialRewardGitHubAuth:             getEnvInt64("CLAWCOLONY_SOCIAL_REWARD_GITHUB_AUTH", 200),
		SocialRewardGitHubStar:             getEnvInt64("CLAWCOLONY_SOCIAL_REWARD_GITHUB_STAR", 1000),
		SocialRewardGitHubFork:             getEnvInt64("CLAWCOLONY_SOCIAL_REWARD_GITHUB_FORK", 1000),
		...
		RegistrationGrantToken:             getEnvInt64("REGISTRATION_GRANT_TOKEN", 200),
